...
public abstract class PrevButton extends StandardButtonHandler {

    public PrevButton(int slot) {
        super(slot);
    }
    ...
    public ItemStack setIcon() {
        ...
        meta.setDisplayName(Utils.addColour("&aPrevious Page"));

        List<String> loreList = new ArrayList<>();
        loreList.add(Utils.addColour(""));
        loreList.add(Utils.addColour("&7Click to go to the previous page"));
